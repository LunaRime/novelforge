...
export const IPC_CHANNEL_POLICY: Record<InvokeChannel, ChannelPolicy> = {
  'browser:list-tabs': { authority: 'dev-only' },
  'browser:test': { authority: 'dev-only' },
  ...
  'db:blueprint-get': { authority: 'write-project' },
  'db:blueprint-get-all': { authority: 'write-project' },
  'db:blueprint-get-all-sorted': { authority: 'write-project' },
  'db:blueprint-get-gaps': { authority: 'write-project' },
  ...
  'db:character-get-all': { authority: 'write-project' },
  ...
  'db:character-update-appearance-stats': { authority: 'write-project' },
  ...
  'db:draft-get-all-chapter-numbers': { authority: 'write-project' },
  'db:draft-get-finalized': { authority: 'write-project' },
  'db:draft-get-full': { authority: 'write-project' },
  'db:draft-get-latest': { authority: 'write-project' },
  'db:draft-get-max-finalized-chapter': { authority: 'write-project' },
  'db:draft-get-meta': { authority: 'write-project' },
  'db:draft-list': { authority: 'write-project' },
  ...
  'db:evaluation-list-by-draft': { authority: 'write-project' },
  ...
  'db:post-process-get-latest-run': { authority: 'write-project' },
  'db:post-process-get-steps': { authority: 'write-project' },
  ...
  'db:preference-get-top': { authority: 'write-project' },
  'db:preference-record': { authority: 'write-project' },
  'db:project-core-get': { authority: 'write-project' },
  'db:project-core-update': { authority: 'write-project' },
  'db:publication-delete': { authority: 'destructive' },
  'db:publication-list': { authority: 'write-project' },
  'db:publication-save': { authority: 'write-project' },
  'db:review-create': { authority: 'write-project' },
  'db:review-get-full': { authority: 'write-project' },
  'db:review-get-latest': { authority: 'write-project' },
  'db:review-list': { authority: 'write-project' },
  'db:review-next-index': { authority: 'write-project' },
  'db:revision-create': { authority: 'write-project' },
  'db:revision-get-full': { authority: 'write-project' },
  'db:revision-get-pending': { authority: 'write-project' },
  'db:revision-list': { authority: 'write-project' },
  ...
  'db:usage-stats': { authority: 'write-project' },
  'db:usage-stats-global': { authority: 'read-global' },
  'db:volume-delete': { authority: 'destructive' },
  'db:volume-get-all': { authority: 'write-project' },
  'db:volume-get-by-chapter': { authority: 'write-project' },
  'db:volume-upsert': { authority: 'write-project' },
  'dev:invoke': { authority: 'dev-only' },
  'dev:test': { authority: 'dev-only' },
  ...
  'fs:agent-archive-list': { authority: 'write-project' },
